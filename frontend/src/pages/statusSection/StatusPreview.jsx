...
const StatusPreview = ({
  ...
  const handleDeleteStatus = () => {
    const statusId = currentStatus?.id || currentStatus?._id;

    if (onDelete && statusId) {
      onDelete(statusId);
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute top-0 left-0 flex justify-between p-4 z-10 gap-1">
          ...
          {isOwnerstatus && (
            <div className="absolute bottom-4 left-4 right-4">
              <button
                ...
                className="flex items-center justify-center w-full text-white bg-black bg-opacity-50 rounded-lg px-4 py-2 hover:bg-opacity-70 transition-all"
              >
                <div className="flex items-center space-x-2">
